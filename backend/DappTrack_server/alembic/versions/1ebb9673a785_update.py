...
def upgrade() -> None:
    ...
    sa.Column('cost_to_complete', sa.Integer(), nullable=True),
    ...
    sa.Column('expected_tge_date', sa.DateTime(), nullable=True),
    sa.Column('airdrop_start_date', sa.DateTime(), nullable=True),
    sa.Column('airdrop_end_date', sa.DateTime(), nullable=True),
    sa.Column('is_tracked', sa.Boolean(), nullable=True),
    sa.Column('expected_token_ticker', sa.String(), nullable=True),
    sa.Column('external_airdrop_url', sa.String(), nullable=True),
